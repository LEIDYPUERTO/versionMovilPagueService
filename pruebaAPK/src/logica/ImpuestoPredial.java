...
public class ImpuestoPredial  implements java.io.Serializable {
     ...
     private int NPredio;
     private String fechaPagoPredial;
    ...
    public ImpuestoPredial(int NPredio, String fechaPagoPredial, double valorPredio, double impuestoPredio) {
    ...
    public String getFechaPagoPredial() {
        return this.fechaPagoPredial;
    }
    
    public void setFechaPagoPredial(String fechaPagoPredial) {
        this.fechaPagoPredial = fechaPagoPredial;
    }
